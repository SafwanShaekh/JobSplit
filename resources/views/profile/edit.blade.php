                                ...
                                <ul class="container grid grid-cols-5 gap-5">
                                    <li>
                                        <a href="index-2.html" class="link flex flex-col items-center gap-2 text-button p-2 rounded-lg bg-white duration-300 shadow-md">
                                            <img src="{{ asset('assets/images/components/home1.webp') }}" alt="home1" class="w-full rounded" />
                                    ...
                                    <li>
                                        <a href="freelancer2.html" class="link flex flex-col items-center gap-2 text-button p-2 rounded-lg bg-white duration-300 shadow-md">
                                            <img src="{{ asset('assets/images/components/home2.webp') }}" alt="home2" class="w-full rounded" />
                                    ...
                                    <li>
                                        <a href="freelancer3.html" class="link flex flex-col items-center gap-2 text-button p-2 rounded-lg bg-white duration-300 shadow-md">
                                            <img src="{{ asset('assets/images/components/home3.webp') }}" alt="home3" class="w-full rounded" />
                                    ...
                                    <li>
                                        <a href="freelancer4.html" class="link flex flex-col items-center gap-2 text-button p-2 rounded-lg bg-white duration-300 shadow-md">
                                            <img src="{{ asset('assets/images/components/home4.webp') }}" alt="home4" class="w-full rounded" />
                                    ...
                                    <li>
                                        <a href="freelancer5.html" class="link flex flex-col items-center gap-2 text-button p-2 rounded-lg bg-white duration-300 shadow-md">
                                            <img src="{{ asset('assets/images/components/home5.webp') }}" alt="home5" class="w-full rounded" />
                                    ...
                                    <li>
                                        <a href="freelancer6.html" class="link flex flex-col items-center gap-2 text-button p-2 rounded-lg bg-white duration-300 shadow-md">
                                            <img src="{{ asset('assets/images/components/home6.webp') }}" alt="home6" class="w-full rounded" />
                                    ...
                                    <li>
                                        <a href="freelancer7.html" class="link flex flex-col items-center gap-2 text-button p-2 rounded-lg bg-white duration-300 shadow-md">
                                            <img src="{{ asset('assets/images/components/home7.webp') }}" alt="home7" class="w-full rounded" />
                                    ...
                                    <li>
                                        <a href="freelancer8.html" class="link flex flex-col items-center gap-2 text-button p-2 rounded-lg bg-white duration-300 shadow-md">
                                            <img src="{{ asset('assets/images/components/home8.webp') }}" alt="home8" class="w-full rounded" />
                                    ...
                                    <li>
                                        <a href="jobs9.html" class="link flex flex-col items-center gap-2 text-button p-2 rounded-lg bg-white duration-300 shadow-md">
                                            <img src="{{ asset('assets/images/components/home9.webp') }}" alt="home9" class="w-full rounded" />
                                    ...
                                    <li>
                                        <a href="jobs10.html" class="link flex flex-col items-center gap-2 text-button p-2 rounded-lg bg-white duration-300 shadow-md">
                                            <img src="{{ asset('assets/images/components/home10.webp') }}" alt="home10" class="w-full rounded" />
                                    ...
                                    <li>
                                        <a href="jobs11.html" class="link flex flex-col items-center gap-2 text-button p-2 rounded-lg bg-white duration-300 shadow-md">
                                            <img src="{{ asset('assets/images/components/home11.webp') }}" alt="home11" class="w-full rounded" />
                                    ...
                                    <li>
                                        <a href="jobs12.html" class="link flex flex-col items-center gap-2 text-button p-2 rounded-lg bg-white duration-300 shadow-md">
                                            <img src="{{ asset('assets/images/components/home12.webp') }}" alt="home12" class="w-full rounded" />
                                    ...
                                    <li>
                                        <a href="rtl13.html" class="link flex flex-col items-center gap-2 text-button p-2 rounded-lg bg-white duration-300 shadow-md">
                                            <img src="{{ asset('assets/images/components/home13.webp') }}" alt="home13" class="w-full rounded" />
                    ...
                    <div class="user_block relative max-sm:hidden">
                       ...
                       <img src="{{ auth()->user()->profile_picture 
                        ...
                        <ul class="list_action_user absolute w-[240px] p-3 top-14 right-0 bg-white rounded-lg">
                            ...
                            <li class="action_item">
                                <a href="{{ route('logout')}}" class="link flex items-center gap-3 w-full py-3 px-6 rounded-lg duration-300 hover:bg-background">
                ...
                <div class="inner scrollbar_custom max-h-full py-6 px-3">
                    ...
                    <div class="area mt-6">
                        ...
                        <ul class="list_link flex flex-col gap-2 mt-2">
                            ...
                            <li>
                                <a href="{{ route('profile.edit') }}" class="link flex items-center gap-3 w-full py-3 px-6 rounded-lg duration-300 hover:bg-background active">
                ...
                <div class="inner scrollbar_custom max-h-full py-6 px-3">
                    ...
                    <div class="area mt-6">
                        ...
                        <ul class="list_link flex flex-col gap-2 mt-2">
                            ...
                            <li>
                                <a href="employers-profile-setting.html" class="link flex items-center gap-3 w-full py-3 px-6 rounded-lg duration-300 hover:bg-background active">
                                    <span class="ph-duotone ph-read-cv-logo text-2xl text-secondary"></span>
                                    <strong class="text-title">Profile Setting</strong>
                                </a>
                            </li>
...
<!-- Mirrored from freelanhub.vercel.app/employers-profile-setting.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 17 Aug 2025 10:58:30 GMT -->
</html>
