...
<!-- Mirrored from freelanhub.vercel.app/employers-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 17 Aug 2025 10:58:21 GMT -->
...
<head>
    ...
    <body class="lg:overflow-hidden">
            ...
            <div class="header_inner absolute flex items-center justify-between top-0 left-0 right-0 z-[1] w-full sm:h-20 h-16 min-[1600px]:px-15 lg:px-9 px-4 border-b border-line">
                        ...
                        <li class="h-full relative">
                            ...
                            <div class="sub_menu sub_menu_home overflow-x-hidden fixed w-full left-0 top-20 py-10 bg-white rounded-lg">
                                <ul class="container grid grid-cols-5 gap-5">
                                    <li>
                                        <a href="index-2.html" class="link flex flex-col items-center gap-2 text-button p-2 rounded-lg bg-white duration-300 shadow-md">
                        ...
                        <li class="h-full relative">
                            ...
                            <div class="sub_menu absolute p-3 -left-10 w-max bg-white rounded-lg">
                                <ul>
                                    ...
                                    <li>
                                        <a href="employers-dashboard.html" class="link flex items-center justify-between gap-2 w-full text-button py-[11px] px-6 rounded duration-300 active"> Employer Dashboard </a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="h-full relative">
                            ...
                            <div class="sub_menu absolute p-3 -left-10 w-max bg-white rounded-lg">
                                <ul>
                                    ...
                                    <li>
                                        <a href="login.html" class="link flex items-center justify-between gap-2 w-full text-button py-[11px] px-6 rounded duration-300"> Login </a>
                                    </li>
                                    <li>
                                        <a href="register.html" class="link flex items-center justify-between gap-2 w-full text-button py-[11px] px-6 rounded duration-300"> Register </a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                ...
                <div class="list_action flex items-center gap-5">
                    <div class="help_block max-sm:hidden">
                        <a href="term-of-use.html" class="block">
                   ...
                   <img src="{{ auth()->user()->profile_picture 
                        ...
                        : asset('storage/public/images/default-avatar.png') }}" 
                        ...
                        <ul class="list_action_user absolute w-[240px] p-3 top-14 right-0 bg-white rounded-lg">
                            ...
                            <li class="action_item">
                                <a href="{{ route('login') }}" class="link flex items-center gap-3 w-full py-3 px-6 rounded-lg duration-300 hover:bg-background">
        ...
        <div class="dashboard_main overflow-hidden lg:w-screen lg:h-screen flex sm:pt-20 pt-16">
            <div class="menu_dashboard overflow-hidden flex-shrink-0 min-[320px]:w-[280px] w-[80vw] h-full bg-white relative z-[2] max-lg:hidden">              <div class="inner scrollbar_custom max-h-full py-6 px-3">
                    <div class="area">
                        <span class="px-6 text-xs font-semibold text-secondary uppercase">Overviews</span>
                        <ul class="list_link flex flex-col gap-2 mt-2">
                            <li>
                                <a href="{{ route('dashboard') }}" class="link flex items-center gap-3 w-full py-3 px-6 rounded-lg duration-300 hover:bg-background active">
                    ...
                    <div class="area mt-6">
                        ...
                        <ul class="list_link flex flex-col gap-2 mt-2">
                            ...
                            <li>
                                <a href="{{ route('profile.edit')}}" class="link flex items-center gap-3 w-full py-3 px-6 rounded-lg duration-300 hover:bg-background">
                ...
                <div class="container h-fit lg:pt-15 lg:pb-30 max-lg:py-12 max-sm:py-8">
                    ...
                    <div class="profile_block overflow-hidden flex max-lg:flex-col-reverse gap-y-10 w-full mt-7.5">
                        <div class="left flex-shrink-0 lg:w-[29.5%]">
                            ...
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d452.4699838931269!2d67.05847152477443!3d24.872049677611745!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3eb33eeca8432bf5%3A0x81dece3730c9b1c5!2sAptech%20Computer%20Education%20Tariq%20Road!5e0!3m2!1sen!2s!4v1757241544054!5m2!1sen!2s" width="300" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                           </div>
                                <ul class="employers_info pt-1">
                                    <li class="industry flex flex-wrap items-center justify-between gap-1 w-full py-4 border-b border-line">
                                        ...
                                        <strong class="text-title">http://www.avitex.vn</strong>
                                    </li>
                                    ...
                                    <li class="phone flex flex-wrap items-center justify-between gap-1 w-full py-4 border-b border-line">
                                        ...
                                        <strong class="text-title">Internet Publishing</strong>
                                    </li>
                                    ...
                                    <li class="experience flex flex-wrap items-center justify-between gap-1 w-full py-4 border-b border-line">
                                        ...
                                        <strong class="text-title">2020</strong>
                                    </li>
                                </ul>
                            </div>
                            <div class="list_social p-8 mt-7.5 rounded-lg bg-white shadow-sm">
                                <h5 class="heading5">Link Social</h5>
                                <ul class="list flex flex-col gap-3 mt-5">
                                    <li class="w-full">
                                        <a href="https://www.facebook.com/" target="_blank" class="w-full py-2 flex items-center justify-center gap-3 border border-line rounded-full bg-surface text-black duration-300 hover:bg-primary hover:text-white">
                                            <span class="icon-facebook text-lg"></span>
                                            <span>Facebook</span>
                                        </a>
                                    </li>
                                    <li class="w-full">
                                        <a href="https://www.linkedin.com/" target="_blank" class="w-full py-2 flex items-center justify-center gap-3 border border-line rounded-full bg-surface text-black duration-300 hover:bg-primary hover:text-white">
                                            <span class="icon-linkedin text-lg"></span>
                                            <span>Linkedin</span>
                                        </a>
                                    </li>
                                    <li class="w-full">
                                        <a href="https://www.twitter.com/" target="_blank" class="w-full py-2 flex items-center justify-center gap-3 border border-line rounded-full bg-surface text-black duration-300 hover:bg-primary hover:text-white">
                                            <span class="icon-twitter text-lg"></span>
                                            <span>Twitter</span>
                                        </a>
                                    </li>
                                    <li class="w-full">
                                        <a href="https://www.instagram.com/" target="_blank" class="w-full py-2 flex items-center justify-center gap-3 border border-line rounded-full bg-surface text-black duration-300 hover:bg-primary hover:text-white">
                                            <span class="icon-instagram text-lg"></span>
                                            <span>Instagram</span>
                                        </a>
                                    </li>
                                    <li class="w-full">
                                        <a href="https://www.pinterest.com/" target="_blank" class="w-full py-2 flex items-center justify-center gap-3 border border-line rounded-full bg-surface text-black duration-300 hover:bg-primary hover:text-white">
                                            <span class="icon-pinterest text-lg"></span>
                                            <span>Pinterest</span>
                                        </a>
                                    </li>
                                    <li class="w-full">
                                        <a href="https://www.youtube.com/" target="_blank" class="w-full py-2 flex items-center justify-center gap-3 border border-line rounded-full bg-surface text-black duration-300 hover:bg-primary hover:text-white">
                        ...
                        <div class="right lg:w-[70.5%] lg:pl-7.5">
                           <div class="about p-8 rounded-lg bg-white shadow-sm">
                            ...
                            <div class="gallery p-8 mt-7.5 rounded-lg bg-white shadow-sm">
                                <h5 class="heading5">Gallery</h5>
                                <div class="images overflow-hidden w-full mt-5">
                                    <div class="swiper swiper-thumb-images section-swiper-navigation rounded-xl">
                                        <button class="custom-button-prev -border lg:left-6 left-4">
                                            <span class="ph-bold ph-arrow-left text-xl"></span>
                                        </button>
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <img src="assets/images/company/gallery1.webp" alt="company/gallery1" class="w-full h-full object-cover" />
                                            </div>
                                            <div class="swiper-slide">
                                                <img src="assets/images/company/gallery2.webp" alt="company/gallery2" class="w-full h-full object-cover" />
                                            </div>
                                            <div class="swiper-slide">
                                                <img src="assets/images/company/gallery3.webp" alt="company/gallery3" class="w-full h-full object-cover" />
                                            </div>
                                            <div class="swiper-slide">
                                                <img src="assets/images/company/gallery4.webp" alt="company/gallery4" class="w-full h-full object-cover" />
                                            </div>
                                            <div class="swiper-slide">
                                                <img src="assets/images/company/gallery5.webp" alt="company/gallery5" class="w-full h-full object-cover" />
                                            </div>
                                        </div>
                                        <button class="custom-button-next -border lg:right-6 right-4">
                                            <span class="ph-bold ph-arrow-right text-xl"></span>
                                        </button>
                                    </div>
                                    <div class="swiper swiper-list-images mt-4">
                                        <div class="swiper-wrapper">
                                ...
                                <ul class="list_related flex flex-col md:gap-7.5 gap-6 w-full mt-5">
                                    <li class="jobs_item px-6 py-5 rounded-lg bg-white shadow-md duration-300 hover:shadow-xl">
                                        <div class="jobs_info flex gap-4 w-full pb-4 border-b border-line">
                                            <a href="jobs-detail1.html" class="overflow-hidden flex-shrink-0 w-15 h-15">
                                        ...
                                        <div class="jobs_more_info flex flex-wrap items-center justify-between gap-3 pt-4">
                                            <div class="flex flex-wrap items-center gap-2.5">
                                                <a href="jobs-default.html" class="jobs_tag caption1 tag bg-surface duration-300 hover:bg-primary hover:text-white">Part-Time</a>
                                                <a href="jobs-default.html" class="jobs_tag caption1 tag bg-surface duration-300 hover:bg-primary hover:text-white">UX/UI</a>
                                            </div>
                                    ...
                                    <li class="jobs_item px-6 py-5 rounded-lg bg-white shadow-md duration-300 hover:shadow-xl">
                                        ...
                                        <div class="jobs_more_info flex flex-wrap items-center justify-between gap-3 pt-4">
                                            <div class="flex flex-wrap items-center gap-2.5">
                                                <a href="jobs-default.html" class="jobs_tag caption1 tag bg-surface duration-300 hover:bg-primary hover:text-white">Part-Time</a>
                                                <a href="jobs-default.html" class="jobs_tag caption1 tag bg-surface duration-300 hover:bg-primary hover:text-white">Web Design</a>
                                            </div>
                                            <div class="jobs_price">
                                        ...
                                        <div class="project_innner flex max-sm:flex-col items-center justify-between xl:gap-9 gap-6 h-full">
                                            <div class="project_info">
                                                <div class="flex flex-wrap items-center gap-3 mb-3">
                                                    <a href="employers-detail1.html" class="avatar overflow-hidden flex-shrink-0 w-15 h-15">
                                                        <img src="assets/images/company/1.png" alt="company/1" class="jobs_avatar w-full h-full object-cover" />
                                                    </a>
                                                    <div>
                                                        <a href="project-detail1.html" class="project_name heading6 duration-300 hover:underline">Rockstar Games New York</a>
                                                ...
                                                <a href="project-detail1.html" class="project_name heading6 duration-300 hover:underline">Website Design for an Online Tutoring Website</a>
                                            ...
                                            <div class="project_more_info flex flex-shrink-0 max-sm:flex-wrap sm:flex-col sm:items-end items-start sm:gap-7 gap-4 max-sm:w-full sm:h-full">
                                                ...
                                                <a href="project-detail1.html" class="button-main -border h-fit">See more</a>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="project_item py-5 px-6 rounded-lg bg-white duration-300 shadow-md">
            ...
            <div class="modal_item menu_dashboard -modal overflow-hidden relative flex-shrink-0 min-[320px]:w-[280px] w-[80vw] h-full bg-white" data-type="menu_dashboard">
                <div class="inner scrollbar_custom max-h-full py-6 px-3">
                    ...
                    <div class="area mt-6">
                        ...
                        <ul class="list_link flex flex-col gap-2 mt-2">
                            <li>
                                <a href="{{ route('profile.show')}}" class="link flex items-center gap-3 w-full py-3 px-6 rounded-lg duration-300 hover:bg-background active">
                                    <span class="ph-duotone ph-user-circle text-2xl text-secondary"></span>
                                    <strong class="text-title">My Profile</strong>
                                </a>
                            </li>
...
<!-- Mirrored from freelanhub.vercel.app/employers-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 17 Aug 2025 10:58:23 GMT -->
</html>